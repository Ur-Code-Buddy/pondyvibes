          ...
          <div className="bg-white bg-opacity-90 p-4 rounded-lg shadow-lg w-full max-w-2xl mx-auto border border-gray-300 mb-8">
            ...
            <form onSubmit={handleSubmit}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <div className="md:col-span-2"><label htmlFor="info" className="block text-gray-800 font-medium mb-1 text-sm">Additional Information / Special Requests</label><textarea name="info" id="info" className="w-full border border-gray-300 p-1 rounded text-sm" placeholder="Any special requests? Would you perhaps like to have breakfast?" /></div>
              </div>
